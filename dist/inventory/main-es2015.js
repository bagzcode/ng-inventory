...
const routes = [
    ...
    { path: "apps", loadChildren: () => Promise.all(/*! import() | application-application-module */[__webpack_require__.e("common"), __webpack_require__.e("application-application-module")]).then(__webpack_require__.bind(null, /*! ./application/application.module */ "./src/app/application/application.module.ts")).then(m => m.ApplicationModule) },
    { path: 'admin', loadChildren: () => Promise.all(/*! import() | admin-layout-admin-layout-module */[__webpack_require__.e("common"), __webpack_require__.e("admin-layout-admin-layout-module")]).then(__webpack_require__.bind(null, /*! ./admin-layout/admin-layout.module */ "./src/app/admin-layout/admin-layout.module.ts")).then(m => m.AdminLayoutModule), canActivate: [_core_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]] },
    { path: 'login', loadChildren: () => Promise.all(/*! import() | login-login-module */[__webpack_require__.e("common"), __webpack_require__.e("login-login-module")]).then(__webpack_require__.bind(null, /*! ./login/login.module */ "./src/app/login/login.module.ts")).then(m => m.LoginModule), canActivate: [_core_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]] },
];
...
module.exports = __webpack_require__(/*! /Users/kerthyayana/Documents/Programming/angular_practice/inventory-copy/src/main.ts */"./src/main.ts");
