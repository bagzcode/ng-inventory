      ...
      _createClass(LoginComponent, [{
        ...
        value: function onSubmit(value) {
          ...
          this.authService.doLogin(value).then(function (res) {
            _this.errorMessage = "";
            _this.successMessage = "successfully login";
